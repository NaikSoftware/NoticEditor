	...
	public void initialize(URL location, ResourceBundle res) {
		choiceBoxModes.setConverter(new StringConverter<WebImporter.Mode>() {
			...
			public String toString(WebImporter.Mode mode) {
				switch (mode) {
					case BASIC_WITH_IMAGES: return res.getString("basic_with_img");
					case ONLY_TEXT: return res.getString("only_text");
					case RELAXED: return res.getString("relaxed");
					case SIMPLE_TEXT: return res.getString("simple_text");
					case ORIGINAL: return res.getString("original");
					default: BASIC: return res.getString("basic");
				}
			}
