...
public final class Notification {
    ...
    static {
        Parent rootNode = Context.getPrimaryStage().getScene().getRoot();

        notificationBox = Context.findById(rootNode, "#notificationBox");
        notificationLabel = Context.findById(rootNode, "#notificationLabel");
